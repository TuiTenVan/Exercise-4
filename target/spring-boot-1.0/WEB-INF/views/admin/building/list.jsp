...
<%--                                                            value la key--%>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="col-xs-9">
                                                        <form:checkboxes path="typeCode" items="${buildingType}"></form:checkboxes>
                                                    </div>
                                                </div>
                                                <div class="col-xs-12">
                                                    <div class="col-xs-6">
            ...
            <div class="row">
                <div class="col-xs-12" style="margin-top: 30px;">
                    <table id="tableList" style="text-align: center;" class="table table-striped table-bordered table-hover">
                        <thead >
                        <tr >
                            <th class="center">
                                <label class="pos-rel">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <div class="hidden-sm hidden-xs btn-group">
                                        <button class="btn btn-xs btn-success" title="Giao tòa nhà" onclick="assignmentBuilding(${item.id})" name="buildingid">
