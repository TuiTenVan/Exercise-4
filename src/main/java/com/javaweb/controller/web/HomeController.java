...
public class HomeController {
    ...
    public ModelAndView contact(@ModelAttribute("customerContact") CustomerDTO customerDTO, HttpServletRequest request){
    ...
    public ModelAndView register(@ModelAttribute("userRegister") UserDTO userDTO) {
